...
var webRoot = './src/main/webapp/protobuf/';
// Copy dependencies to '/protobuf' (example specific, you usually don't have to care
var deps = [
    [webRoot+'long.js', './node_modules/protobufjs/node_modules/bytebuffer/node_modules/long/dist/long.js'],
    [webRoot+'bytebuffer.js', './node_modules/protobufjs/node_modules/bytebuffer/dist/bytebuffer.js'],
    [webRoot+'protobuf.js', './node_modules/protobufjs/dist/protobuf.js']
];
...
var TestProtobuf = ProtoBuf.loadProtoFile(webRoot+'TestProtobuf.proto').build('TestProtobuf'),
